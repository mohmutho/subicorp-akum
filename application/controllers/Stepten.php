...
class Stepten extends CI_Controller {
	...
	public function index(){
        ...
        $data['pages'] = $this->load->view('pages/stepten',array('main'=>$data),true);
	...
	function create() {
        ...
        $this->session->set_flashdata('notif','<div class="alert alert-success alert-dismissible"><strong>Hutang Lainnya berhasil disimpan. </strong><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>');
		redirect('stepten');
	}
	...
	function edit() {
        ...
        $this->session->set_flashdata('notif','<div class="alert alert-success alert-dismissible"><strong>Hutang Lainnya berhasil diubah. </strong><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>');
		redirect('stepten');
	}
	...
	public function delete() {
		...
		$this->session->set_flashdata('notif','<div class="alert alert-success alert-dismissible"><strong> Hutang Lainnya berhasil dihapus.</strong><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>');
		redirect('stepten');
	}
}