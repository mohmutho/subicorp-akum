...
class Stepnine extends CI_Controller {
	...
	public function index(){
		$data['title'] = 'Akum';
		$data['sql'] = $this->db->query("SELECT * FROM hutang WHERE jenis_hutang = 'bank' AND iduser = ".$this->session->userdata('id')."");
		$data['sidebar'] = $this->load->view('layouts/sidebar','',true);
        $data['pages'] = $this->load->view('pages/stepnine',array('main'=>$data),true);
	...
	function create() {
        ...
        $this->session->set_flashdata('notif','<div class="alert alert-success alert-dismissible"><strong>Hutang Bank berhasil disimpan. </strong><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>');
		redirect('stepnine');
	}
	...
	function edit() {
        ...
        $this->session->set_flashdata('notif','<div class="alert alert-success alert-dismissible"><strong>Hutang Bank berhasil diubah. </strong><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>');
		redirect('stepnine');
	}
	...
	public function delete() {
		...
		$this->session->set_flashdata('notif','<div class="alert alert-success alert-dismissible"><strong> Hutang Bank berhasil dihapus.</strong><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button></div>');
		redirect('stepnine');
	}
}