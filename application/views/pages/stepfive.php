  ...
  <div class="col-sm-12">
    <div class="stepone-page-left">
      <section class="content-header">
        ...
        <p>Masukan Data Persediaan Perlengkapan dan Barang Lainnya Anda saat ini : </p>
      </section>
      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header">
            <div class="box-title"><a href="#" data-toggle="modal" data-target="#myModal" class="btn btn-akumm"><i class="fa fa-plus"></i> Tambah Persediaan Barang Lainnya</a></div>
          </div>
          <div class="box-body">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                      ...
                      <td><?php echo number_format($obj->total_nilai_barang / $obj->jumlah_barang,0, '', '.');?></td><td>
        ...
        <div class="align-right">
          <a href="<?php echo base_url();?>stepfour" class="btn btn-akumm"><i class="fa fa-angle-left"></i> Back</a>
          <a href="<?php echo base_url();?>stepsix" class="btn btn-akumm">Next <i class="fa fa-angle-right"></i></a>
        </div>
      </section>
    </div>
  </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <?php echo form_open_multipart('stepfive/create/');?>
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 id="myModalLabel" align="center">Persediaan Barang Lainnya</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <input type="text" name="jumlah_barang" placeholder="Jumlah Barang" id="jumlah_barang" required>
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <input type="text" name="harga_satuan" placeholder="Harga Satuan" id="harga_satuan" required>
...
<div class="modal fade" id="myModalEdit<?php echo $obj2->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <?php echo form_open_multipart('stepfive/edit/');?>
...
<div class="modal fade" id="myModalDelete<?php echo $obj3->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <?php echo form_open_multipart('stepfive/delete/');?>
