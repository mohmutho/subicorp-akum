            ...
            <div class="box-body">
              ...
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  ...
                  <li><a href="#tab_3" data-toggle="tab">Riwayat Piutang Transaksi Pokok</a></li>
                  <li><a href="#tab_4" data-toggle="tab">Riwayat Piutang Transaksi Lainnya</a></li>
                </ul>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                              ...
                              <td><?php echo $obj->tanggal_jatuh_tempo;?></td>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                              ...
                              <td><?php echo $obj->status;?></td>
                              <td>
                                <a href="#" class="btn btn-xs btn-primary" data-toggle="modal" data-target=".piutang2<?php echo $obj->id;?>">
                                  <i class='fa fa-eye'></i> View Image
                                </a>
                              </td>
                          </tr>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                              ...
                              <td>
                                <a href="#" class="btn btn-xs btn-primary" data-toggle="modal" data-target=".piutang3<?php echo $obj->id;?>">
                                  <i class='fa fa-eye'></i> View Image
                                </a>
                              </td>
                          </tr>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                              ...
                              <td><?php echo $obj->ket;?></td>
                              <td>
                                <a href="#" class="btn btn-xs btn-primary" data-toggle="modal" data-target=".piutang4<?php echo $obj->id;?>">
                                  <i class='fa fa-eye'></i> View Image
                                </a>
                              </td>
                          </tr>
...
<?php
  foreach ($main['sql2']->result() as $obj)
  {
      $id = $obj->id;
?>
<div class="modal fade piutang2<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<?php
  foreach ($main['sql3']->result() as $obj)
  {
      $id = $obj->id;
?>
<div class="modal fade piutang3<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
<?php
  foreach ($main['sql4']->result() as $obj)
  {
      $id = $obj->id;
?>
<div class="modal fade piutang4<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
