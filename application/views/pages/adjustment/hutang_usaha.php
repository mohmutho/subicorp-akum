  ...
  <div class="col-sm-12">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Hutang Usaha</li>
        </ol><br>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
              <div class="col-sm-10">
                <a href="#" data-toggle="modal" data-target="#myModal" class="btn btn-akumm"><i class="fa fa-plus"></i> Tambah Hutang Usaha</a>
              </div>
              <div class="col-sm-2">
                <div class="align-right">
                  <a href="<?php echo base_url();?>adjustment/activa_lainnya" class="btn btn-akumm"><i class="fa fa-angle-left"></i> Back</a>
                  <a href="<?php echo base_url();?>adjustment/hutang_non_usaha" class="btn btn-akumm">Next <i class="fa fa-angle-right"></i></a>
                </div>
              </div>
            </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <td>
                          <a href="#" class="btn btn-xs btn-primary" data-toggle="modal" data-target=".hutang_usaha<?php echo $obj->id;?>">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <?php echo form_open_multipart('adjustment/create_hutang_usaha/');?>
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 id="myModalLabel" align="center">Hutang Usaha</h4>
    </div>
    <div class="modal-body">
      <div class="row">
        <div class="col-sm-12">
          <label>Nama Hutang Usaha</label>
...
<div class="modal fade" id="myModalEdit<?php echo $obj2->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <?php echo form_open_multipart('adjustment/edit_hutang_usaha/');?>
...
<div class="modal fade" id="myModalDelete<?php echo $obj3->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <?php echo form_open_multipart('adjustment/delete_hutang_usaha/');?>
...
<?php
  foreach ($main['sql']->result() as $obj)
  {
    $id = $obj->id;
?>
<div class="modal fade hutang_usaha<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
