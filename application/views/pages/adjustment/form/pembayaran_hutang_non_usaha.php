    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body form-horizontal">
                <?php echo form_open_multipart('adjustment/create_pembayaran_hutang_non_usaha/');?>
                ...
                <div class="autoSum">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <a href="<?php echo site_url('adjustment/pembayaran_hutang_non_usaha');?>" class="btn btn-default">Kembali</a>
