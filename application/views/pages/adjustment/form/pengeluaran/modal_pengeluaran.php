    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body form-horizontal">
              <?php echo form_open_multipart('adjustmentpengeluaran/create_pengeluaran_modal/');?>
              <div class="autoSum">
                  ...
                  <div class="form-group">
                      <label for="inputName" class="col-sm-2 control-label">Tanggal Setor</label>
                      <div class="col-sm-10">
                          <input type="text" name="tanggal_transaksi" class="form-controls" id="datepicker" placeholder="Tanggal Setor" required>
                      </div>
                  </div>
                  <div class="form-group">
                      <label for="inputName" class="col-sm-2 control-label">Upload Bukti Setor</label>
                      <div class="col-sm-10">
