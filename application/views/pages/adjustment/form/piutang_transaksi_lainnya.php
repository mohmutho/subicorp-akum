  ...
  <div class="col-sm-12">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <?php echo form_open_multipart('adjustment/create_piutang_transaksi_lainnya/');?>
            ...
            <input type="hidden" name="id" value="<?php echo $id;?>">
                <div class="autoSum">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                        <a href="<?php echo site_url('adjustment/piutang_transaksi_lainnya');?>" class="btn btn-default">Kembali</a>
