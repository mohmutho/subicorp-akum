    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
              <div class="col-sm-10">
                <a href="<?php echo site_url('adjustment/form_piutang_transaksi_pokok');?>" class="btn btn-akumm"><i class="fa fa-plus"></i> Tambah Piutang Transaksi Pokok</a>
              </div>
              <div class="col-sm-2">
                <div class="align-right">
                  <a href="<?php echo base_url();?>adjustment/pembayaran_hutang_non_usaha" class="btn btn-akumm"><i class="fa fa-angle-left"></i> Back</a>
                  <a href="<?php echo base_url();?>adjustment/piutang_non_usaha" class="btn btn-akumm">Next <i class="fa fa-angle-right"></i></a>
                </div>
              </div>
            </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <td>
                          <a class="btn btn-xs btn-info" href="<?php echo base_url();?>adjustment/form_piutang_transaksi_pokok_edit/<?php echo $obj->id;?>"><i class='fa fa-edit'></i></a>
...
<div class="modal fade" id="myModalDelete<?php echo $obj3->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <?php echo form_open_multipart('adjustment/delete_piutang_transaksi_pokok/');?>
