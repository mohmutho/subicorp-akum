  ...
  <div class="col-sm-12">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Pembayaran Hutang Non Usaha</li>
        </ol><br>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
              <div class="col-sm-10">
                <a href="<?php echo site_url('adjustment/form_pembayaran_hutang_non_usaha');?>" class="btn btn-akumm"><i class="fa fa-plus"></i> Tambah Pembayaran Hutang Non Usaha</a>
              </div>
              <div class="col-sm-2">
                <div class="align-right">
                  <a href="<?php echo base_url();?>adjustment/pembayaran_hutang_usaha" class="btn btn-akumm"><i class="fa fa-angle-left"></i> Back</a>
                  <a href="<?php echo base_url();?>adjustment/piutang_transaksi_pokok" class="btn btn-akumm">Next <i class="fa fa-angle-right"></i></a>
                </div>
              </div>
            </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <td>
                          <a href="#" class="btn btn-xs btn-primary" data-toggle="modal" data-target=".bayar_hutang<?php echo $obj->id;?>">
                            <i class='fa fa-eye'></i> View Image
                          </a>
                        </td>
                        <td>
                          <a class="btn btn-xs btn-info" href="<?php echo base_url();?>adjustment/form_pembayaran_hutang_non_usaha_edit/<?php echo $obj->id;?>"><i class='fa fa-edit'></i></a>
...
<?php
  foreach ($main['sql']->result() as $obj)
  {
    $id = $obj->id;
?>
<div class="modal fade bayar_hutang<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
...
<div class="modal fade" id="myModalDelete<?php echo $obj3->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <?php echo form_open_multipart('adjustment/delete_pembayaran_hutang_non_usaha/');?>
