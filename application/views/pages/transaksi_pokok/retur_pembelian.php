                ...
                <div class="autoSum">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <option value="">Pilih</option>
                                ...
                                <?php
                                    $jsArray .= "prdName['". $obj->id . "'] = {jumlah:'" . addslashes($jumlah) . "',nama_barang:'" . addslashes($nama_barang) . "',total_harga:'" . addslashes($total_harga) . "',pembelian_dari:'" . addslashes($pembelian_dari) . "'};\n";
                                    }
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input readonly type="hidden" name="pembelian_dari" id="pembelian_dari" class="form-controls" placeholder="Nama Barang" required>
                        </div>
                    </div>
                    <div class="form-group">
