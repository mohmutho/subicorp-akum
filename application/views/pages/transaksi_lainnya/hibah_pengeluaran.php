    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body form-horizontal">
              <?php echo form_open_multipart('pengeluaran/create_pengeluaran_hibah/');?>
                <div class="autoSum">
                  ...
                  <div class="form-group">
                      <label for="inputName" class="col-sm-2 control-label">Nama Penerima Hibah</label>
                      <div class="col-sm-10">
                          <input type="text" name="nama_hibah" class="form-controls" placeholder="Nama Penerima Hibah" required>
                      </div>
                  </div>
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        ...
                        <select name="nama_barang" id="id_barang" class="form-controls-select" required>
                          <option value="">Pilih Barang</option>
                          <?php 
                            foreach ($sql->result() as $val) {
                          ?>
                          <option value="<?php echo $val->nama_activa;?>"><?php echo $val->nama_activa;?></option>
                          <?php
                            }
                          ?>
                          <?php 
