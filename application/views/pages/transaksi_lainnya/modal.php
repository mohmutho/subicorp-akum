    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body form-horizontal">
              <?php echo form_open_multipart('pemasukan/create_pemasukan_modal/');?>
                <div class="autoSum">
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <input type="text" name="tanggal_setor" class="form-controls" id="datepicker" placeholder="Tanggal Setor" required>
                      </div>
                  </div>
                  <div class="form-group">
