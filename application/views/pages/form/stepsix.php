  ...
  <div class="col-sm-12">
    <div class="stepsix-page-left">
      ...
      <section class="content">
          <div class="box-body">
          <?php echo form_open('stepsix/create/')?>
          ...
          <div class="autoSum">
            <div class="row">
              ...
              <div class="col-sm-8">
                <label>Jenis Activa Tetap</label>
            ...
            <div class="row">
              <div class="col-sm-2"></div>
              <div class="col-sm-8">
                <label>Nama Activa Tetap</label>
                <input type="text" placeholder="Nama Activa Tetap" name="nama_activa" value="<?php echo $nama_activa;?>" required>
              </div>
              <div class="col-sm-2"></div>
            </div>
            <div class="row">
              ...
              <div class="col-sm-8">
                ...
                <input type="text" name="nilai_tanah" id="nilai_tanah" placeholder="Nilai Tanah" value="<?php echo $nilai_tanah;?>" required>
            ...
            ?>
              <div class="row">
                ...
                <div class="col-sm-8">
                  ...
                  <input type="text" id="nilai_bangunan" name="nilai_bangunan" placeholder="Nilai Bangunan" value="<?php echo $nilai_bangunan_fix;?>">
              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                  ...
                  <select name="jenis_bangunan" class="form-control" onchange="show_value2(this.value)">
              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                  ...
                  ?>
                    ...
                    <input id="ne" placeholder="Masukan tahun (10 tahun)" value="<?php echo $nilai_ekonomi;?>">
                  </div>
                  <?php
                    if ($main['op']=='tambah') {
                      ?>
                  ...
                  ?>
                    <label>Nilai Ekonomi (dalam tahun)</label>
                    <input type="text" id="nek" placeholder="Masukan tahun (20 - 30 tahun)" value="<?php echo $nilai_ekonomi;?>">
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                  ...
                  <input type="text" name="tahun_berdiri" class="tahun_berdiri" id="datepicker" placeholder="Tahun Berdiri" value="<?php echo $tahun_berdiri;?>">
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                ...
                <input type="text" name="tahun_beli" class="tahun_beli" id="datepicker2" placeholder="Tahun Beli" value="<?php echo $tahun_beli;?>" required>
              </div>
              <div class="col-sm-2"></div>
            </div>
            <?php
            ...
            ?>
              ...
              <div class="row">
                <div class="col-sm-2"></div>
                <div class="col-sm-8">
                  <label>Harga Sisa (dalam tahun)</label>
                  <input type="text" readonly id="harga_sisa" placeholder="Harga Sisa" value="Rp. <?php echo $harga_sisa;?>">
            ...
            <div class="row">
              ...
              <div class="col-sm-8">
                <label>Alamat</label>
                <textarea name="alamat" cols="10" rows="5" placeholder="Alamat" required><?php echo $alamat;?></textarea>
              </div>
              <div class="col-sm-2"></div>
            </div>
            <div class="row">
              ...
              <div class="col-sm-8">
                ...
                <input type="number" name="no_sertifikat" placeholder="No. Sertifikat Tanah" value="<?php echo $no_sertifikat;?>" required>
              </div>
              <div class="col-sm-2"></div>
            </div>
            <div class="row">
              ...
              <div class="col-sm-8 align-right">
                <a href="<?php echo base_url();?>stepsix" class="btn btn-default">Kembali</a>
