  ...
  <div class="col-sm-12">
    <div class="stepsix-page-left">
      ...
      <section class="content">
        ...
        <?php echo form_open('stepfinish/update_status/')?>
        <input type="hidden" name="status_opening" value="1">
        <div class="align-right">
          <a href="<?php echo base_url('stepeleven');?>" class="btn btn-akumm"><i class="fa fa-angle-left"></i> Back</a>
          <button type="submit" class="btn btn-akumm">Finish <i class="fa fa-angle-right"></i></a>
        </div>
        <?php echo form_close()?>
      </section>
    </div>
