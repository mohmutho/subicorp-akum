...
if($foto == ''){
    ...
    $lokasi = "$path/piutang_lain_bukti/$namafoto";
...
$insert = "INSERT INTO piutang(iduser, jenis_piutang, nama_piutang, nilai_piutang, tanggal_transaksi, tanggal_jatuh_tempo, bukti_transaksi, keterangan, status) 
VALUES('$idUser','lainnya','$nama','$nilai','$tanggal_trans','$tanggal_jatuh','$namafoto','$keterangan', '$status')";
